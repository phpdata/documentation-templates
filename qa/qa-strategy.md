...
Functional testing of underlying services, which is not dependant on a completed UI, but scenarios can usually covered if RESTful services are being used.
